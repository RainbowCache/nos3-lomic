 ...
 *
 * Purpose:
 * Extra scaffolding functions for the cannon_app unit test
 *
 * Notes:
...
#ifndef UT_CANNON_APP_H
#define UT_CANNON_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "CANNON_APP_Data_t" typedef.
 */
#include "cannon_app.h"

/*
 * Allow UT access to the global "CANNON_APP_Data" object.
 */
//extern CANNON_AppData_t CANNON_APP_Data;

#endif /* UT_CANNON_APP_H */
